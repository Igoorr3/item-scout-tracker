...
- O 'cf_clearance' é do Cloudflare e pode mudar com mais frequência.
    ...
    def _setup_tab_widgets(self, tab_frame, tab_id):
        ...
        columns = ('nome', 'preco', 'dps', 'divine_potential', 'vendedor', 'data_listagem', 'whisper')
    ...
    def process_item(self, item_data, query_id, tab_id):
        ...
        try:
            ...
            tree_values = (full_name, price_text, dps_pdps_str, divine_potential_str, seller, listing_date_display, "Copiar")
    ...
    def on_item_double_click(self, event, tab_id):
         ...
         if column_index == 6:  # Coluna 'whisper'
