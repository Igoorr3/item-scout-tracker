...
# -- Constantes --
CONFIG_FILE = 'poe2_config.ini'  # Arquivo .ini onde os cookies são armazenados
STAT_MAP = {
...
class PoeTracker:
    def __init__(self, root):
        ...
        # Carregar cookies do arquivo .ini
        self.load_config()
    ...
    def load_config(self):
        if os.path.exists(CONFIG_FILE):
            ...
            # Carregar cookies e configurações do arquivo .ini
            # ...

    def save_config(self):
        # Salvar cookies e configurações no arquivo .ini
        config = configparser.ConfigParser()
        # ... código para salvar no arquivo .ini
...
if __name__ == "__main__":
  ...
  return (
    <>
      {/* Adicionar botão grande de voltar no início */}
      <div className="mb-6">
        <Button 
          variant="outline" 
          size="lg" 
        ...
        <CardContent>
          <Alert className="mb-4 bg-amber-500/10 border-amber-500/50">
            ...
            <AlertDescription className="text-sm">
              ...
              Os cookies e configurações são armazenados no arquivo 'poe2_config.ini' fora do script Python.
            </AlertDescription>
          </Alert>
          ...
          <div className="grid gap-4">
            ...
            {configVisible && (
              <div className="border border-border p-4 rounded-lg mt-2">
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  ...
                  O arquivo 'poe2_config.ini' armazena os cookies e configurações fora do script Python.
                </p>
              </div>
            )}
            ...
            <Alert className="mt-2">
              ...
              <AlertDescription className="text-sm">
                Para utilizar esta integração completamente, você precisa de um servidor Python rodando (como Flask ou FastAPI) que execute o script e retorne os resultados. 
                O arquivo 'poe2_config.ini' é criado automaticamente pelo script Python para armazenar os cookies e outras configurações.
              </AlertDescription>
            </Alert>
          </div>
        </CardContent>
